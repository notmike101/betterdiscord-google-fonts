...
var Plugin = class {
  ...
  load() {
    this.logger = new Logger("GoogleFonts v2.0.17", "lightblue", "white");
    this.selectedFont = (0, import_bdapi2.getData)("betterdiscord-google-fonts", "selectedFont") ?? null;
  ...
  applyFont(fontName) {
    (0, import_bdapi2.clearCSS)("betterdiscord-google-fonts-customfont");
    if (!!fontName) {
      ...
      `;
      (0, import_bdapi2.injectCSS)("betterdiscord-google-fonts-customfont", style);
    } else {
  ...
  fontChangeCallback(fontName) {
    ...
    (0, import_bdapi2.setData)("betterdiscord-google-fonts", "selectedFont", fontName);
    this.applyFont(fontName);
  }
  getSettingsPanel() {
    return /* @__PURE__ */ import_bdapi2.React.createElement(SettingsPanel_default, {
      fonts: this.fonts,
